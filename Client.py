...
IKey_Ser = Point(0xce1a69ecc226f9e667856ce37a44e50dbea3d58e3558078baee8fe5e017a556d, 0x13ddaf97158206b1d80258d7f6a6880e7aaf13180e060bb1e94174e419a4a093, Curve.get_curve('secp256k1'))
...
SPKPUB_x_server, SPKPUB_Y_server, h_server, s_server = SPKReg(h,s, SPKPub.x, SPKPub.y, stuID)
...
if SPKverified is True:
    ...
    for y in range(0,10):
        ...
        print("{i}th key generated. Private part={private}".format(i = y, private = OTKPri))
    ...
    h, s = generateSignature(n, P, stuID, IKAPri)
    ResetSPK(h,s, stuID)
    print("SPK and OTKs are deleted!")
    print("+++++++++++++++++++++++++++++++++++++++++++++")
